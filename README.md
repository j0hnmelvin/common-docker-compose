...
## References
- [Confluent Community License version of Confluent Platform](https://github.com/confluentinc/cp-all-in-one/blob/6.1.1-post/cp-all-in-one-community/docker-compose.yml)